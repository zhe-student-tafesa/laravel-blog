...
class CategoryController extends Controller
{
    ...
    public function index(){               //全部分类 列表
        //return 'Admin/article的 index';//返回 欢迎 界面
        //echo 'GET|HEAD                               | admin/category ';
    ...
    public function create(){//             添加分类
        ...
        return view('admin/category/add',compact('data')); // 使用add.blade.php页面 +返回 数据
    } 
    ...
    //GET|HEAD                               | admin/category/{category}      | category.show    有参数
    ...
    //PUT|PATCH                              | admin/category/{category}      | category.update    有参数
