...
<article>
  ...
  <div class="bloglist left">
    ...
    <p class="dateview"><span>{{date('M-d-Y', $v->art_time )}}</span><span>作者：{{$v->art_editor}}</span> </p>
    @endforeach
    <div class="page" id="pagessss2">
      {{$hotList->links()}}
    </div>
    <style>
      #pagessss2 {
  ...
  <aside class="right">
    ...
    <div class="news" style="float: left;">
      ...
      <ul class="website">
        <!-- 备注 links的link_url 字段必须 含有 http:://  *** -->
