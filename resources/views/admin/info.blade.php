    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                ...
                <li>
                    <label>静静设计-版本</label><span>v-1.1</span>
                </li>
                <li>
                    <label>上传附件限制</label><span>2M</span>
                </li>
                <li>
                    <label>Adelaide Time</label><span><?php echo date('H:i:s,  d,M,Y')?></span>
                </li>
                <li>
                    <label>服务器域名/IP</label><span> {{$_SERVER['SERVER_NAME']}} [ {{$_SERVER['MEMCACHED_HOST']}} ]</span>
                </li>
                <li>
                    <label>Host</label><span>{{$_SERVER['MEMCACHED_HOST']}}</span>
                </li>
            </ul>
        </div>
    </div>
